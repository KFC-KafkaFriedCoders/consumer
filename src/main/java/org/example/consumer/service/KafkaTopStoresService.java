...
public class KafkaTopStoresService {
    ...
    private static final String TOPIC = "top_stores";
    private static final String GROUP_ID = "top-stores-consumer-group11";
    ...
    private CompletableFuture<Void> processRecordAsync(ConsumerRecord<String, String> record) {
        return CompletableFuture.runAsync(() -> {
            try {
                ...
                batchProcessor.queueTopStoresMessage(jsonObject);
            } catch (Exception e) {
