...
public class KafkaSameUserService {
    ...
    private static final String TOPIC = "same_user_payment";
    private static final String GROUP_ID = "same-user-consumer-group11";
    ...
    private CompletableFuture<Void> processRecordAsync(ConsumerRecord<String, String> record) {
        return CompletableFuture.runAsync(() -> {
            try {
                ...
                batchProcessor.queueSameUserMessage(jsonObject);
            } catch (Exception e) {
